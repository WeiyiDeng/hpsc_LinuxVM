...
def requestBands(search_term):  
    ...
    trend_payload_lab = {'q': search_term, 'cat': '3'}
...
f = open('/home/uwhpsc/wdocs/pytrends/bands4061_cat3/search_list.csv', "w")
f2 = open('/home/uwhpsc/wdocs/pytrends/bands4061_cat3/problem_list.csv', "w")
f3 = open('/home/uwhpsc/wdocs/pytrends/bands4061_cat3/stopped_list.csv', "w")
...
for band in search_terms:
	try:
		...
		path = "/home/uwhpsc/wdocs/pytrends/bands4061_cat3/" + str(index+1) + "_cat3.csv"
