...
def requestSuggestions(band_name):  
    ...
    if suggested_labels ==[]:
	    ...
	    ind = 0
	    for k in range(length_labels):                    # w: bug fixed here ! beware of identation mistakes
...
f = open('/home/uwhpsc/wdocs/pytrends/bands4061_lab/search_list.csv', "w")
f2 = open('/home/uwhpsc/wdocs/pytrends/bands4061_lab/problem_list.csv', "w")
f3 = open('/home/uwhpsc/wdocs/pytrends/bands4061_lab/stopped_list.csv', "w")
...
for band in search_terms:
	try:
		...
		path = "/home/uwhpsc/wdocs/pytrends/bands4061_lab/" + str(index+1) + "_lab.csv"
