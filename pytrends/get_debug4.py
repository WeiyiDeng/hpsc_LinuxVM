...
def requestSuggestions(band_name):  
    ...
    target_terms = ["band","songwriter","singer","artist","musical","composer","music producer","duo","performer","actor","musician","dj","electronic duo","rapper","group","pianist","trio","vocalist","instrumentalist","bass","cellist","conductor","drummer","guitarist","violinist","soprano","orchestra","choir"]
...
for band in search_terms:
	try:
		...
		if lab_problem+search_problem>0:
			...
			print([band + '_problem'])
			mydoc2.writerow([search_list[index]])
		else:
			search_list = search_list+[band_sugg]
		...
		print([band + '_stopped'])
		mydoc3.writerow([search_list[index]])
	finally:
