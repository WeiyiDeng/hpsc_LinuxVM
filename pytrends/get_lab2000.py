...
def requestSuggestions(band_name):  
    ...
    target_terms = ["band","songwriter","singer","artist","musical","composer","music producer","duo","performer","actor","music","dj","electronic duo","rapper","group","pianist","jazz"]
...
for band in search_terms:
	try:
		...
		path = "/home/uwhpsc/wdocs/pytrends/bands2588/" + band + "_lab.csv"
...
f = open('/home/uwhpsc/wdocs/pytrends/bands2588/search_list.csv', "w")
mydoc = csv.writer(f, lineterminator='\n')
mydoc.writerow(search_list)
f.close()

f2 = open('/home/uwhpsc/wdocs/pytrends/bands2588/problem_list.csv', "w")
mydoc = csv.writer(f2, lineterminator='\n')
mydoc.writerow(problem_list)
f2.close()

f3 = open('/home/uwhpsc/wdocs/pytrends/bands2588/stopped_list.csv', "w")
