...
def requestBands(search_term):  
    ...
    trend_payload_lab = {'q': search_term}
...
f = open('/home/uwhpsc/wdocs/pytrends/bands4061_ori/search_list.csv', "w")
f2 = open('/home/uwhpsc/wdocs/pytrends/bands4061_ori/problem_list.csv', "w")
f3 = open('/home/uwhpsc/wdocs/pytrends/bands4061_ori/stopped_list.csv', "w")
...
for band in search_terms:
	try:
		...
		path = "/home/uwhpsc/wdocs/pytrends/bands4061_ori/" + str(index+1) + "_ori.csv"
