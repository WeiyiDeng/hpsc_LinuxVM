...
def requestSuggestions(band_name):  
    ...
    target_terms = ["band","songwriter","singer","artist","musical","composer","music producer","duo","performer","actor","musician","dj","electronic duo","rapper","group","pianist","jazz","pop", "trio"]
    ...
    if suggested_labels ==[]:
		...
		if any(w in label_list['type'].lower() for w in target_terms) and label_list['title'].lower()==band.lower():
