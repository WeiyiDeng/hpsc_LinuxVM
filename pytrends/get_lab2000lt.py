...
f = open('/home/uwhpsc/wdocs/pytrends/test_problem_lab/search_list.csv', "w")
f2 = open('/home/uwhpsc/wdocs/pytrends/test_problem_lab/problem_list.csv', "w")
f3 = open('/home/uwhpsc/wdocs/pytrends/test_problem_lab/stopped_list.csv', "w")
...
for band in search_terms:
	try:
		...
		path = "/home/uwhpsc/wdocs/pytrends/test_problem_lab/" + str(index+1) + "_lab.csv"
