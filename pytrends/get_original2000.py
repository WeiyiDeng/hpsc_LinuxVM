...
f = open('/home/uwhpsc/wdocs/pytrends/test_problem_ori/search_list.csv', "w")
f2 = open('/home/uwhpsc/wdocs/pytrends/test_problem_ori/problem_list.csv', "w")
f3 = open('/home/uwhpsc/wdocs/pytrends/test_problem_ori/stopped_list.csv', "w")
...
for band in search_terms:
	try:
		...
		path = "/home/uwhpsc/wdocs/pytrends/test_problem_ori/" + str(index+1) + "_ori.csv"
