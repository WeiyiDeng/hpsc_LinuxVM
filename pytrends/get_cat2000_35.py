...
# sample_bands = "/home/uwhpsc/wdocs/pytrends/bands2588/problem_list.csv"
...
f = open('/home/uwhpsc/wdocs/pytrends/test_problem_cat35/search_list.csv', "w")
f2 = open('/home/uwhpsc/wdocs/pytrends/test_problem_cat35/problem_list.csv', "w")
f3 = open('/home/uwhpsc/wdocs/pytrends/test_problem_cat35/stopped_list.csv', "w")
...
for band in search_terms:
	try:
		...
		path = "/home/uwhpsc/wdocs/pytrends/test_problem_cat35/" + str(index+1) + "_cat35.csv"
